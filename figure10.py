...
plt.scatter(star_xo, star_xir, color = '#FF0000', marker = '^', s = 3, label = 'Star')
plt.scatter(star_xo_cp, star_xir_cp, facecolors = 'None', edgecolors = '#FF0000', linewidth = 0.5, s = 25)  # Point out sources without optical and IR counterparts
...
plt.scatter(agn_xo, agn_xir, color = '#AEB404', marker = '*', s = 3, label = 'AGN')
plt.scatter(sy1n_xo, sy1n_xir, color = '#FF0000', marker = '^', s = 3, label = 'Sy1n')
plt.scatter(qso_xo, qso_xir, color = '#BF00FF', marker = 'D', s = 3, label = 'QSO')
plt.scatter(sy1_xo, sy1_xir, color = '#01DF74', marker = 'v', s = 3, label = 'Sy1')
plt.scatter(sy2_xo, sy2_xir, color = '#08088A', marker = ',', s = 3, label = 'Sy2')
plt.scatter(lin_xo, lin_xir, color = '#FE2EC8', marker = '*', s = 3, label = 'LIN')
plt.scatter(bla_xo, bla_xir, color = '#000000', marker = 'o', s = 3, label = 'Bla')
...
plt.scatter(cv_xo, cv_xir, color = '#AEB404', marker = '*', s = 3, label = 'CV')
plt.scatter(bhb_xo, bhb_xir, color = '#FF0000', marker = '^', s = 3, label = 'BHB')
plt.scatter(mgr_xo, mgr_xir, color = '#BF00FF', marker = 'D', s = 3, label = 'MGR')
plt.scatter(bstr_xo, bstr_xir, color = '#01DF74', marker = 'v', s = 3, label = 'Bstr')
plt.scatter(apsr_xo, apsr_xir, color = '#08088A', marker = ',', s = 3, label = 'aPsr')
plt.scatter(rpsr_xo, rpsr_xir, color = '#FE2EC8', marker = '*', s = 3, label = 'rPsr')
plt.scatter(ins_xo, ins_xir, color = '#000000', marker = 'o', s = 3, label = 'INS')
lgnd3 = plt.legend(loc = 'upper left', scatterpoints = 1, fontsize = 5)
lgnd3.get_frame().set_linewidth(0.0)

# ========== Output ========== #
fig.savefig('fig10.eps',format = 'eps', bbox_inches = 'tight', pad_inches = 0.02, dpi = 1000)
